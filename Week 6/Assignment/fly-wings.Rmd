...
Does the data look like it follows a normal distribution, apart from small discrepancies like rounding? Yes it does. 

There's one thing about the data that might make one suspicious that the data is made up. The suspicious thing is: The graphs look very neat and perfect which real life datasets don't usually look like
